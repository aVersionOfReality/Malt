                ...
                if name not in meshes:
                    ...
                    if malt_mesh:
                        ...
                        compute_params = {
                            ...
                            'dm_factor': getattr(mesh_data, 'malt_dm_factor', 1.0),
                            'dm_use_attr_factor': getattr(mesh_data, 'malt_dm_use_attr_factor', True),
                            'dm_scale': getattr(mesh_data, 'malt_dm_scale', 1.0),
                            'dm_cotangent_factor': getattr(mesh_data, 'malt_dm_cotangent_factor', 1.0),
                            'dm_use_attr_scale': getattr(mesh_data, 'malt_dm_use_attr_scale', True),
